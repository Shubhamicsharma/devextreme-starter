...
export class CDSOptionsComponent {
  ...
  optionFields = [
    ...
    { name: 'Premium', label: 'Premium', type: 'number', placeholder: 'Enter amount' },
       { name: 'Upfront', label: 'Upfront', type: 'text' ,placeholder: 'Enter amount' },
           { name: 'Upfront Date', label: 'Upfront Date', type: 'date', placeholder: 'Select date' },
    
    { name: 'Strike Rate', label: 'Strike Rate', type: 'number', placeholder: 'Enter strike rate' },
       { name: 'Upfront/Ccy/FXRate', label: 'FX Rate', type: 'number', placeholder: 'Enter FX rate' },
         {
     ...
     { name: 'optionExpiry', label: 'Option Expiry Date', type: 'date', placeholder: 'Select date' },
  ...
  cdsFields = [
    { name: 'underlyingIsin', label: 'Underlying ISIN', placeholder: 'Enter ISIN', type: 'text' },
    { name: 'redCode', label: 'Red Code', placeholder: 'Enter Red Code', type: 'text' },
    { name: 'indexSpread', label: 'Index/Spread', placeholder: 'Spread bps', type: 'number' },
    { name: 'fixedRate', label: 'Fixed Rate', placeholder: 'Rate %' , type: 'number'},
    { name: 'accuredInterest', label: 'Accrued Interest', placeholder: 'Enter Interest', type: 'text' },
    { name: 'dayCount', label: 'Day Count', placeholder: 'Select an option' , type: 'select', options: ['30/360', 'ACT/360', 'ACT/365']},
    { name: 'firstCoupon', label: 'First Coupon Date', placeholder: 'dd-mm-yyyy', type: 'date' },
    { name: 'frequency', label: 'Frequency', placeholder: 'Select an option' , type: 'select', options: ['Monthly', 'Quarterly', 'Semi-Annual', 'Annual'] },
    { name: 'tradeRationale', label: 'Trade Rationale', placeholder: 'Rationale', type: 'text' }
  ];
  ...
  closeModal() {
    if (this.tradeForm.dirty) {
      confirm('Are you sure you want to close? Any unsaved changes will be lost.', 'Confirm close')
        .then((result) => {
          if (result) {
